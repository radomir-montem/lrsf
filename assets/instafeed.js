...
!(function (e, t) {
  'object' == typeof exports && 'undefined' != typeof module
    ...
    ? define(t)
    : ((e = 'undefined' != typeof globalThis ? globalThis : e || self).Instafeed = t());
})(this, function () {
  'use strict';
  function e(e, t) {
  ...
  function t(t) {
    ...
    e(
      ...
      'target must be a string or DOM node, got ' + o.target + ' (' + typeof o.target + ')'
    ),
      e(
        'string' == typeof o.accessToken || 'function' == typeof o.accessToken,
        'accessToken must be a string or function, got ' + o.accessToken + ' (' + typeof o.accessToken + ')'
      ),
      e(
        'number' == typeof o.accessTokenTimeout,
        'accessTokenTimeout must be a number, got ' + o.accessTokenTimeout + ' (' + typeof o.accessTokenTimeout + ')'
      ),
      e(
        'number' == typeof o.apiTimeout,
        'apiTimeout must be a number, got ' + o.apiTimeout + ' (' + typeof o.apiTimeout + ')'
      ),
      ...
      e(
        ...
        'template must null or string, got ' + o.template + ' (' + typeof o.template + ')'
      ),
      e(
      ...
      e(
        ...
        'before must be null or function, got ' + o.before + ' (' + typeof o.before + ')'
      ),
      e(
        !o.after || 'function' == typeof o.after,
        'after must be null or function, got ' + o.after + ' (' + typeof o.after + ')'
      ),
      e(
      ...
      e(
        ...
        'filter must be null or function, got ' + o.filter + ' (' + typeof o.filter + ')'
      ),
      e(
        !o.transform || 'function' == typeof o.transform,
        'transform must be null or function, got ' + o.transform + ' (' + typeof o.transform + ')'
      ),
      e(
        !o.sort || 'function' == typeof o.sort,
        'sort must be null or function, got ' + o.sort + ' (' + typeof o.sort + ')'
      ),
      e(
      ...
      e(
        ...
        'limit must be null or number, got ' + o.limit + ' (' + typeof o.limit + ')'
      ),
      e(
        !o.apiLimit || 'number' == typeof o.apiLimit,
        'apiLimit must null or number, got ' + o.apiLimit + ' (' + typeof o.apiLimit + ')'
      ),
  ...
  return (
    ...
    (t.prototype._showNext = function (e) {
      ...
      if ((t._debug('showNext', 'pool', t._state.pool.length, t._state.pool), t._state.pool.length > 0)) {
        if (
          ((n = i ? t._state.pool.splice(0, t._options.limit) : t._state.pool.splice(0)),
          ...
          : ((o =
            ...
            t._options.apiLimit || 'number' != typeof t._options.limit
              ? 'number' == typeof t._options.apiLimit &&
                (t._debug('showNext', 'apiLimit set, overriding limit', t._options.apiLimit, t._options.limit),
                (o = o + '&limit=' + t._options.apiLimit))
              : (t._debug('showNext', 'no apiLimit set, falling back to limit', t._options.apiLimit, t._options.limit),
                (o = o + '&limit=' + t._options.limit))),
          t._debug('showNext', 'making request', o),
          t._makeApiRequest(o, function (o, n) {
            var i = null;
            if (o)
              return t._debug('onResponseReceived', 'error', o), void e(new Error('api request error: ' + o.message));
    ...
    (t.prototype._processData = function (e) {
      var t = 'function' == typeof this._options.transform,
        ...
        p = null;
      if (
        (this._debug('processData', 'hasFilter', o, 'hasTransform', t, 'hasSort', n, 'hasLimit', i),
      ...
      for (var c = 0; c < e.data.length; c++) {
        if (((a = this._getItemData(e.data[c])), t))
          try {
            ...
            throw (
              (this._debug('processData', 'error calling transform', f), new Error('error in transform: ' + f.message))
            );
          }
        else u = a;
        if (o) {
      ...
      if ((this._debug('renderData', 'hasTemplate', t, 'hasRender', o), !('object' != typeof e || e.length <= 0))) {
        ...
        for (
          this._debug('renderData', 'html content', r),
            ...
            this._debug('renderData', 'container', s, s.childNodes.length, s.childNodes);
        ...
        (i.onload = function (e) {
          ...
          if (
            ...
            try {
              ...
              return (
                n._debug('apiRequestOnLoad', 'json parsing error', r, i.responseText),
    ...
    (t.prototype._debug = function () {
      ...
      this._options.debug &&
        ...
        (((e = [].slice.call(arguments))[0] = '[Instafeed] [' + e[0] + ']'), console.log.apply(null, e));
    }),
